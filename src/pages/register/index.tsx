...
import { Layout, Space, Image, Col, Row, Form, Input, Typography, Button } from 'antd'
        ...
        <Content style={contentStyle} >
          <Row style={{ height: '100vh' }}>
            <Col xs={24} sm={24} md={10} lg={10} className='RegiterImageCol'>
              <Image width={'100%'} height={'520px'} src={registerImage} preview={false} className='RegiterImage' />
            </Col>
            <Col xs={24} sm={24} md={14} lg={14} className='formside'>
              ...
              >
                ...
                <div className='RegisterText'>
                  ...
                  <Title level={5} className='backbtn'><LeftOutlined /> Back</Title>
                </div>
                <Title level={5}>
                  Welcome to animal planet! Please Enter your Details for registration
                </Title>
