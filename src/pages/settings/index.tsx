...
export default function Index() {
  ...
  const handlefilterChange = (e: any) => {
    ...
    if (settingComponent === "roles") {
      const filteredData = RoleData.filter((singleRecord: any) => {
        if (
          singleRecord.isActive === e &&
          singleRecord.roleName.includes(searchValue)
        ) {
          return singleRecord;
        } else {
          return null;
  ...
  function onFinishFailed(errorInfo: any): void {
    console.log(
      "🚀 ~ file: index.tsx:23 ~ onFinishFailed ~ errorInfo:",
      errorInfo,
    );
  }
  ...
  const userColumns = [
    ...
    // },
    {
      ...
      render: (status: any, id: any) => {
        return (
          <>
            <div className="statusdiv" style={{ display: "inline-block" }}>
              {status === `Enable` ? (
                <>
                  <Switch
                    size="default"
    ...
    },
    {
      ...
      render: (data: any) => {
        return (
          <Space size={10}>
            <Image
              src={"/assets/images/logos/Group 3580.svg"}
              preview={false}
            ...
            />
            <Image
              src={"/assets/images/logos/Union 95.svg"}
              preview={false}
      ...
      render: (isActive: any) => (
        <>
          <div style={{ display: "flex" }}>
            {isActive === `Active` ? (
              <>
                <Image src={"/assets/images/logos/Path 6129.svg"} />{" "}
                <p style={{ fontWeight: "bold", color: "green" }}>{isActive}</p>
              </>
            ) : (
              <>
                <Image src={"/assets/images/logos/Path 6131.svg"} />{" "}
                <p style={{ fontWeight: "bold", color: "red" }}>{isActive}</p>
              </>
            )}
          </div>
        </>
  ...
  const RolesColumns = [
    ...
    },
    {
      ...
      render: (permission: string) => {
        return (
          <Button
            style={{ border: "none", color: "#0074FF" }}
            onClick={() => {
              setOpenDrawer(true);
  ...
  return (
    <>
      <SettingLayout handleSidebar={handleSidebar}>
        ...
        {settingComponent === "subscription" && <SubcriptionCards />}
        <ConfirmDelete
        ...
        <Drawer
          title={
            permissionDrawer ? "Permission Details" : `Add ${settingComponent}`
          }
          placement={"right"}
          closable={false}
          onClose={onClose}
        ...
        >
          <Form
            ...
            labelAlign="left"
          >
            {settingComponent === "users" && <AddUserForm />}
            {settingComponent === "organizations" && <AddORGForm />}
            {settingComponent === "roles" && (
              <>
                {permissionDrawer ? (
                  <DynamicTable
            ...
            {permissionDrawer ? (
              ...
              >
                ...
                <Col xs={{ span: 10, offset: 1 }} md={10} lg={4} sm={10}>
                  <Button onClick={onClose} block={true} size="large">
                    Cancel
                  </Button>
                </Col>
              </Row>
